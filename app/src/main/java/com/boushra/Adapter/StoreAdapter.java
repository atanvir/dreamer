...
public class StoreAdapter extends RecyclerView.Adapter<StoreAdapter.MyViewHolder> {
    ...
    private List<StorePoints> storePointsList;


    public StoreAdapter(Context context,List<StorePoints> storePointsList) {
    ...
    public void onBindViewHolder(@NonNull StoreAdapter.MyViewHolder myViewHolder, int position) {
        ...
        myViewHolder.coin_im.setImageResource(storePointsList.get(position).getPoint_icon());
        myViewHolder.pushase_sr_txt.setText(storePointsList.get(position).getPoint_detail());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.coin_im)
        ImageView coin_im;

        @BindView(R.id.pushase_sr_txt)
        TextView pushase_sr_txt;
