...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        {
            view=LayoutInflater.from(context).inflate(R.layout.left_chat_adapter,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Log.e("adapter_pos" , String.valueOf(position));
        positiony=position;
        ...
        try {
            ...
            Log.e("server_date",server_date_complete);
            ...
            //long today=difference-86400000;

            long a=difference-(86400000-currrent_date.getTime());
            Log.e("today:", String.valueOf(a));
